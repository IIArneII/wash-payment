...
type DepositHandlerFunc func(DepositParams, *entity.Auth) DepositResponder

// Handle executing the request and returning a response
func (fn DepositHandlerFunc) Handle(params DepositParams, principal *entity.Auth) DepositResponder {
	return fn(params, principal)
}

// DepositHandler interface for that can handle valid deposit params
type DepositHandler interface {
	Handle(DepositParams, *entity.Auth) DepositResponder
}
